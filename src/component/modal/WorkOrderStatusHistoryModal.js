...
/*
    ...
    작업 지시 요청 이력 모달 : ModalType.WORK_ORDER_STATUS_HISTORY_MODAL
...
@observer
class WorkOrderStatusHistoryModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  ...
  render() {
    ...
    return <div>WorkOrderStatusHistoryModal</div>;
  }
}

export default WorkOrderStatusHistoryModal;
